...
def write_client(id, file):
    ...
    file.write(YAML_TAB + YAML_TAB + YAML_TAB + "- CLI_name=" + "Dummy name" + str{id} "\n")
    file.write(YAML_TAB + YAML_TAB + YAML_TAB + "- CLI_surname=" + "Dummy surname" + str(id) + "\n")
    file.write(YAML_TAB + YAML_TAB + YAML_TAB + "- CLI_idNumber=" + "12345678\n")
    file.write(YAML_TAB + YAML_TAB + YAML_TAB + "- CLI_dateOfBirth=" + "1999-07-10" + "\n")
    file.write(YAML_TAB + YAML_TAB + YAML_TAB + "- CLI_number=" + "111" + str(id) + "\n")
    file.write(YAML_TAB + YAML_TAB + "volumes:\n")
