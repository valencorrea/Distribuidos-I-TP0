...
func PrintConfig(v *viper.Viper) {
	log.Infof("action: config | result: success | client_id: %s | name: %s | surname: %s | id_number: %s | date_of_birth: %s | bet_number: %s | server_address: %s | loop_amount: %v | loop_period: %v | log_level: %s",
		v.GetString("id"),
		v.GetString("name"),
		v.GetString("surname"),
